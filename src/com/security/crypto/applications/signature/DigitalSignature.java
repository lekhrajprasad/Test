package com.security.crypto.applications.signature;
...
public class DigitalSignature {
  ...
  */
        ...
        try {
            ...
            System.out.println("Algorithm " + DIGITAL_KEY_ALGO + " not supported by any installed provider");
            System.exit(0);
        } catch (InvalidKeyException ike) {
            System.out.println("Key Generated is not valid");
            System.exit(0);
        } catch (SignatureException se) {
            System.out.println("Error while generating signature");
            System.exit(0);
        } catch (NoSuchProviderException se) {
            System.out.println("Cannot find provider " + PROVIDER);
            System.exit(0);
        }
