...
public class SecurePBKDFUsage {
    ...
    public static String computePBKDF(char[] password) throws GeneralSecurityException {
        ...
        try {
            ...
            throw new GeneralSecurityException("One of the argument is illegal. Salt " + salt + " is of 0 length, iteration count " + ITERATION_COUNT + " is not positive or derived key length " + DERIVED_KEY_LENGTH + " is not positive.");
        }
